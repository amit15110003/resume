...
<div class="container">
        ...
        <a class="waves-effect waves-light btn pink accent-2" href="<?php echo base_url("index.php/education/school"); ?>"><i class="material-icons right">mode_edit</i>High School</a>
 ...
 <br>
    ...
    <?php $attributes = array("name" => "education");
      echo form_open("education/school", $attributes);?>
      <?php
if (isset($data))
{
  ...
  $data=0;
      ...
      <div class="row">
        <div class="input-field col s12">
          <input id="collegename" type="text" class="validate" name="sname" value="<?php echo $sname;?>">
          <label for="name">Name</label>
        </div>
      </div>
      <div class="row">
        <div class="input-field col s12">
          <input id="collegeDepartment" type="text" class="validate" name="sboard" value="<?php echo $sboard;?>">
          <label for="Department">Board</label>
        </div>
      </div>
      <div class="row">
        <div class="input-field col s12">
          <input id="collegeCourse" type="text" class="validate" name="per" value="<?php echo $per;?>">
          <label for="Course">Percentage</label>
        </div>
      </div>
      <div class="row">
        <div class="input-field col s12">
          <input id="collegeYear" type="number" class="validate" name="syear" value="<?php echo $syear;?>">
          <label for="Year">Year Of Study</label>
        </div>
      </div>
      <div class="row">
        <div class="input-field col s12">
          <textarea id="textarea1" class="materialize-textarea" name="additional"><?php echo $additional;?></textarea>
