   ...
   <div class="row ">
      <div class="col s12 m12">
        <div class="card-panel  grey lighten-5 hoverable">
          <span  style=" font-size: 18px; font-weight: bold;  "><?php echo $row->name; ?>
          </span><hr>
          <p > <?php echo $row->desc; ?></p>
          <p > <?php echo $row->duration; ?></p>
          <p > <?php echo $row->add; ?></p>
          <a class="btn-floating btn-large waves-effect waves-light red right" href="<?php echo base_url().'index.php/education/Deletecourses/'.$row->id; ?>"><i class="material-icons">delete</i></a>
        </div>
      </div>
    </div>
<?php }?>
